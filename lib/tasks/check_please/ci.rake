namespace :check_please do
  ...
  task ci_nocop: ['check_please:setup:config_files', :environment, 'check_please:ci_specs']

  desc 'CI build with Rubocop validation'
  task ci: ['check_please:setup:config_files', :environment, 'check_please:rubocop', 'check_please:ci_specs']
  ...
  task ci_specs: :environment do
    ...
    duration = Benchmark.realtime do
      ...
      begin
        Rake::Task['check_please:rspec'].invoke
      rescue SystemExit => e
